...
right_join(trips_new, Stations) %>% 
  ...
  geom_point(aes(color = perccasual)) +
...
Notably, there is no Tuesday row present under the variable `day`. This is most likely due to the fact that the top ten days with the most departures were never on a Tuesday. However, we can see that casual bikers most often rented bikes on Saturdays, with a proportion of 0.45, while registered bikers most often rented bikes on Wednesdays and Thursdays with proportions of 0.33 and 0.31, respectively.
